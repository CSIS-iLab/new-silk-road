# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-16 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ManyToManyField(blank=True, help_text='Client or implementing agency', to='facts.Organization')),
                ('funding_sources', models.ManyToManyField(blank=True, related_name='funded_projects', to='facts.Organization')),
                ('infrastructure_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='facts.InfrastructureType')),
                ('initiative', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='facts.Initiative')),
            ],
        ),
        migrations.CreateModel(
            name='Region',
        ...
        migrations.AlterField(
            model_name='person',
            name='party',
            field=models.CharField(blank=True, help_text='Political part affiliation.', max_length=100),
        ),
        migrations.AddField(
            model_name='project',
            name='regions',
            field=models.ManyToManyField(blank=True, to='facts.Region'),
        ),
        migrations.AddField(
            model_name='initiative',
            name='initiative_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='facts.IntiativeType'),
        ),
    ]
