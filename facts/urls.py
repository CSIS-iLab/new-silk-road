...
urlpatterns = [
    ...
    url(r'^organizations/(?P<slug>\S+)/$', OrganizationDetailView.as_view(), name='facts-organization-detail'),
    ...
    url(r'^events/(?P<slug>\S+)/$', EventDetailView.as_view(), name='facts-event-detail'),
