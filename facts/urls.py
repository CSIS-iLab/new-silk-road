...
app_name = 'facts'
urlpatterns = [
    url(r'^people/(?P<slug>\S+)/(?P<identifier>[a-f0-9-]{32,36})/$', PersonDetailView.as_view(), name='person-detail'),
    url(r'^people/$', PersonListView.as_view(), name='person-list'),
    url(r'^organizations/(?P<slug>\S+)/(?P<identifier>[a-f0-9-]{32,36})/$', OrganizationDetailView.as_view(), name='organization-detail'),
    url(r'^organizations/$', OrganizationListView.as_view(), name='organization-list'),
    url(r'^organizations-redirect/(?P<org_type>[a-z]+)/$', OrganizationListRedirectView.as_view(), name='organization-list-redirect'),
    url(r'^companies/$', CompanyListView.as_view(), name='company-list'),
    url(r'^financing-organizations/$', FinancingOrganizationListView.as_view(), name='financingorganizationdetails-list'),
