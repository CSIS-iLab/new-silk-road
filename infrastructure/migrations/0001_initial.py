    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sources', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=1000, validators=[datautils.validators.URLLikeValidator]), blank=True, default=list, help_text='Enter URLs separated by commas.', null=True, size=None, verbose_name='Sources URLs')),
                ('notes', markymark.fields.MarkdownField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_url', models.CharField(blank=True, max_length=1000, validators=[datautils.validators.URLLikeValidator])),
