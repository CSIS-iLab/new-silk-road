# -*- coding: utf-8 -*-
# Generated by Django 1.9.3 on 2016-03-04 15:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('locations', '0002_auto_20160303_1816'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point', django.contrib.gis.db.models.fields.PointField(blank=True, geography=True, srid=4326)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='place',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='locations.GeographicLocation'),
        ),
        migrations.AddField(
            model_name='region',
            name='geography',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='locations.GeographicRegion'),
        ),
    ]
